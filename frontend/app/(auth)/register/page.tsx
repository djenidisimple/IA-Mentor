      ...
      <main className="flex-1 flex flex-col items-center justify-center relative z-10 px-5 pt-20 pb-10">
        ...
        <div className="w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
                  ...
                  <div className="space-y-1.5">
                    <label className="flex items-center gap-2 font-mono text-[10px] font-bold text-gray-600 uppercase tracking-widest">
                       <UserIcon size={12} className={focusedField === 'username' ? 'text-amber-500' : 'text-gray-400'} />
                       Nom d'utilisateur
                    </label>
                    <div className="relative group">
                       <input
                          ...
                          placeholder="developpeur_pro"
                          required
                          minLength={3}
                          className="w-full bg-gray-50 text-gray-900 font-mono text-sm px-4 py-3 rounded-xl outline-none placeholder:text-gray-400 border-1.5 border-gray-200 focus:border-amber-500 focus:bg-white transition-all shadow-sm group-hover:border-gray-300"
                       />
                  ...
                  <div className="space-y-1.5">
                    <label className="flex items-center gap-2 font-mono text-[10px] font-bold text-gray-600 uppercase tracking-widest">
                       <Mail size={12} className={focusedField === 'email' ? 'text-amber-500' : 'text-gray-400'} />
                       Adresse Email
                    </label>
                    <div className="relative group">
                       <input
                  ...
                  <div className="space-y-1.5">
                    <label className="flex items-center gap-2 font-mono text-[10px] font-bold text-gray-600 uppercase tracking-widest">
                       <Lock size={12} className={focusedField === 'password' ? 'text-amber-500' : 'text-gray-400'} />
                       Mot de passe
                    </label>
                    <div className="relative group">
                       <input
                          ...
                          required
                          minLength={8}
                          className="w-full bg-gray-50 text-gray-900 font-mono text-sm px-4 py-3 pr-11 rounded-xl outline-none placeholder:text-gray-400 border-1.5 border-gray-200 focus:border-amber-500 focus:bg-white transition-all shadow-sm group-hover:border-gray-300"
                       />
                       <button
                          type="button"
                    ...
                    {form.password.length > 0 && (
                      <div className="pt-1 flex gap-1 items-center">
                        ...
                        <span className="text-[9px] font-mono font-bold text-gray-500 ml-2 uppercase tracking-widest min-w-[45px] text-right">
                  ...
                  >
                    {loading ? (
                      <span className="flex items-center gap-2">
                        <TerminalIcon className="h-4 w-4 animate-pulse text-amber-400" />
                        Création...
                      </span>
                    ) : (
                  ...
                  >
                     ...
                     <span className="relative z-10 uppercase">S'inscrire avec Github</span>
                  </a>
            ...
            <p className="text-center text-gray-500 font-mono text-[10px] font-bold tracking-widest mt-8 uppercase">
               Déjà initialisé ?{' '}
               <Link href="/login" className="text-amber-600 hover:text-amber-700 transition-colors inline-flex items-center gap-1 group">
                 Se connecter
